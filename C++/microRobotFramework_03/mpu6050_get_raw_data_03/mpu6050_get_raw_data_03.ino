...
void loop() {
  ...
  if(millis() - timer > 50){
    ...
    data[0] = 0xf5;
    data[1] = (accelX >> 8) & 0xff;
    data[2] = accelX & 0xff;
    data[3] = (accelY >> 8) & 0xff;
    data[4] = accelY & 0xff;
    data[5] = (accelZ >> 8) & 0xff;
    data[6] = accelZ & 0xff;
    data[7] = (gyroX >> 8) & 0xff;
    data[8] = gyroX & 0xff;
    data[9] = (gyroY >> 8) & 0xff;
    data[10] = gyroY & 0xff;
    data[11] = (gyroZ >> 8) & 0xff;
    data[12] = gyroZ & 0xff;
    data[13] = (encoder1 >> 8) & 0xff;
    data[14] = encoder1 & 0xff;
    data[15] = (encoder2 >> 8) & 0xff;
    data[16] = encoder2 & 0xff;
    data[17] = (encoder3 >> 8) & 0xff;
    data[18] = encoder3 & 0xff;
    data[19] = (encoder4 >> 8) & 0xff;
    data[20] = encoder4 & 0xff;
